            ...
            <div class="adm-card-body">
                <div class="adm-form-grid">
                    ...
                    <div class="adm-form-group">
                        ...
                        <input type="text" name="title" value="{{ old('title') }}" required class="adm-input" placeholder="Banner heading text">
                    </div>
                </div>
                ...
                <div class="adm-form-grid" style="margin-top:16px;">
                    <div class="adm-form-group">
                        ...
                        <p class="adm-hint">JPG, PNG or WebP. Max 3MB. Recommended: 1920x600px</p>
                    </div>
                    <div class="adm-form-group">
