    ...
    <div class="adm-sidebar">
        ...
        <nav class="adm-nav">
            ...
            <a href="{{ route('admin.analytics') }}"
               class="adm-nav-link {{ request()->routeIs('admin.analytics') ? 'is-active' : '' }}">
                <span class="icon"><svg fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" viewBox="0 0 24 24"><path d="M3 3v18h18"/><path d="M18 9l-5 5-3-3-5 5"/></svg></span> Analytics
            </a>
