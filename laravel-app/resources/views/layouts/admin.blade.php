            ...
            <a href="{{ route('admin.settings.edit') }}"
               class="adm-nav-link {{ request()->routeIs('admin.settings.*') ? 'is-active' : '' }}">
                ...
                <a href="{{ route('home') }}" target="_blank" rel="noopener"
                    class="adm-nav-link">
                     <span class="icon"><svg fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" viewBox="0 0 24 24"><path d="M3 11.5 12 4l9 7.5"/><path d="M5.5 10v10h13V10"/><path d="M9.5 20v-6h5v6"/></svg></span> Visit Site
                </a>
        </nav>
