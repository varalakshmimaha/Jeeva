...
@section('content')
    ...
    <div class="banner-slider" id="bannerSlider">
              ...
              <div class="banner-slide-shell">
                <div class="banner-slide-content">
                  ...
                  @if($banner->button_text)
                    <a href="{{ $banner->button_link ?? route('contact') }}"
                      class="banner-slide-button">{{ $banner->button_text }}</a>
                  @endif
                </div>
              </div>
            </div>
          ...
          <div class="banner-slide is-active" style="background-image: url('{{ asset('storage/Hero Banner.jpeg') }}');">
            <div class="banner-slide-shell">
              <div class="banner-slide-content">
                ...
                <p class="banner-slide-description">Compassionate birth doula support, prenatal yoga, and childbirth
                  education for your journey into motherhood.</p>
      ...
      @if($banners->count() > 1)
        ...
        <div class="banner-slider-dots" id="bannerDots">
          @foreach($banners as $index => $banner)
            <button class="banner-dot {{ $index === 0 ? 'is-active' : '' }}" data-index="{{ $index }}"
      ...
      <div class="about-wrapper">
        ...
        <div class="about-content-col reveal">
          ...
          <div class="about-text-body">
            <p>I am Anu &mdash; a Birth Doula, Prenatal Yoga Instructor, Childbirth Educator, Nutritionist, and a mother
              of two. I believe every woman deserves to feel seen, heard, and supported throughout her pregnancy, birth,
              and postpartum journey. My intention is to create a calm, safe, and nurturing space where you feel empowered
              without judgment and guided without pressure.</p>
          </div>
      ...
      <div class="why-journey-grid why-journey-grid--four">
        ...
        <div class="why-journey-step reveal d1">
          <div class="why-img-wrap why-icon-wrap">
            <img
              src="{{ !empty($siteSettings['why_choose_image_1']) ? asset($siteSettings['why_choose_image_1']) : asset('images/why-choose/01_new.png') }}"
              alt="Personalized, One-on-One Support" class="why-icon">
        ...
        <div class="why-journey-step reveal d2">
          <div class="why-img-wrap why-icon-wrap">
            <img
              src="{{ !empty($siteSettings['why_choose_image_2']) ? asset($siteSettings['why_choose_image_2']) : asset('images/why-choose/02_new.png') }}"
              alt="Holistic Approach to Wellness & Birth" class="why-icon">
          ...
          <p class="why-card-text">A unique blend of nutrition, prenatal yoga, and doula support to guide you physically
            and emotionally.</p>
        </div>
        ...
        <div class="why-journey-step reveal d3">
          <div class="why-img-wrap why-icon-wrap">
            <img
              src="{{ !empty($siteSettings['why_choose_image_3']) ? asset($siteSettings['why_choose_image_3']) : asset('images/why-choose/03_new.png') }}"
              alt="Guided by Experience & Understanding" class="why-icon">
          ...
          <p class="why-card-text">As a mother of two, I bring both professional knowledge and real-life empathy to every
            client I support &mdash; helping you make informed decisions for your birth.</p>
        </div>
        ...
        <div class="why-journey-step reveal d4">
          <div class="why-img-wrap why-icon-wrap">
            <img
              src="{{ !empty($siteSettings['why_choose_image_4']) ? asset($siteSettings['why_choose_image_4']) : asset('images/why-choose/04_new.png') }}"
              alt="Ongoing Support & Guidance" class="why-icon">
            <div class="why-badge">04</div>
          </div>
          <h3 class="why-card-title">Ongoing Support &amp; Guidance</h3>
          <p class="why-card-text">You're never alone in your journey &mdash; I'm here to support you every step of the
            way.</p>
        </div>
      </div>
    </div>
  ...
  <section class="services-section">
    <div class="container">
      <div class="section-header text-center">
        ...
        <p class="section-subtitle">From your first check-up to complete smile transformations — all under one trusted
          roof.</p>
      </div>
      ...
      <div class="services-cta">
        <a href="{{ route('services') }}" class="services-cta-btn">View All Services <span
  ...
  <section class="book-appointment-section" id="book-appointment">
      ...
      <div class="appointment-wrapper">
        ...
        <div class="appointment-split">
          <div class="appointment-image reveal">
            <img src="{{ asset('storage/Baby.jpeg') }}" alt="Book a complimentary consultation with Anu">
          </div>
                ...
                <div class="booking-modal-card">
                  <div class="booking-modal-icon">
                    <svg viewBox="0 0 52 52" width="46" height="46" aria-hidden="true">
                      ...
                      <path d="M14 27l8 8 16-18" fill="none" stroke="#2FA9A3" stroke-width="3.5" stroke-linecap="round"
                        stroke-linejoin="round" class="bm-check" />
                    </svg>
                  </div>
                  <h3 class="booking-modal-title">{{ $modalTitle }}</h3>
                  <p class="booking-modal-text">{{ session('success') }}</p>
                  @if($modalSub)
                  <p class="booking-modal-sub">{{ $modalSub }}</p>@endif
                  <button type="button" class="booking-modal-btn"
                    onclick="document.getElementById('bookingSuccessModal').remove()">Got it</button>
                </div>
              </div>
            @endif
            @if($errors->any())
            ...
            <form action="{{ route('contact.store') }}" method="POST" class="book-form" id="homeBookConsultationForm">
              ...
              <div class="bf-field">
                ...
                <div class="bf-phone-group">
                  ...
                  <input type="tel" name="phone" class="bf-phone-number" placeholder="Phone Number"
              ...
              <div class="bf-field">
                ...
                <select name="service_selected" required>
                  ...
                  @foreach(($services ?? []) as $service)
                    <option value="{{ $service->title }}" {{ old('service_selected') === $service->title ? 'selected' : '' }}>
              ...
              <div class="bf-field">
                ...
                <button type="button" class="bf-cal-trigger" id="homeBfOpenCal">
                  ...
                  <span id="homeBfCalBtnText">Select a date &amp; time</span>
                  <svg class="bf-cal-chev" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                    stroke-width="2.5">
                    <polyline points="6 9 12 15 18 9" />
                  </svg>
                </button>
                <div id="homeBfTimeConfirm" class="bf-time-confirm" style="display:none;">
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#16a34a" stroke-width="2.5"
                    stroke-linecap="round" stroke-linejoin="round">
                    <polyline points="20 6 9 17 4 12" />
                  </svg>
                  <span id="homeBfTimeLabel">Appointment scheduled</span>
                  <button type="button" class="bf-change-btn" id="homeBfChangeSlot">Change</button>
                </div>
              </div>
              ...
              <div class="bf-field">
                ...
                <textarea name="message" rows="3"
                  placeholder="Anything you'd like us to know...">{{ old('message') }}</textarea>
              </div>
    ...
    <style>
      ...
      .bf-cal-trigger:hover {
        border-color: #4DB6AC;
        background: #ffffff;
      }

      .bf-cal-trigger.has-value {
        color: #2b2b2b;
      }
      ...
      .bf-phone-group .bf-phone-number:focus {
        outline: none;
      }
  ...
  <section class="htsd-sec">
    ...
    <div class="htsd-grass htsd-grass-left">
      <svg viewBox="0 0 200 500" fill="none">
        <path d="M120,500 Q100,400 110,300 Q115,200 105,100 Q100,50 110,0" stroke="#4DB6AC" stroke-width="2"
          opacity="0.15" />
        <path d="M110,300 Q70,270 40,210" stroke="#4DB6AC" stroke-width="1.5" opacity="0.12" />
        <path d="M110,300 Q70,270 40,210 Q80,260 110,300" fill="#4DB6AC" opacity="0.06" />
        <path d="M108,200 Q65,175 35,120" stroke="#4DB6AC" stroke-width="1.5" opacity="0.12" />
        <path d="M108,200 Q65,175 35,120 Q78,172 108,200" fill="#4DB6AC" opacity="0.06" />
        <path d="M112,400 Q75,375 45,320" stroke="#4DB6AC" stroke-width="1.5" opacity="0.10" />
        <path d="M112,400 Q75,375 45,320 Q82,370 112,400" fill="#4DB6AC" opacity="0.04" />
      </svg>
    </div>
    <div class="htsd-grass htsd-grass-right">
      <svg viewBox="0 0 200 500" fill="none">
        <path d="M80,500 Q100,400 90,300 Q85,200 95,100 Q100,50 90,0" stroke="#4DB6AC" stroke-width="2" opacity="0.12" />
        <path d="M90,300 Q130,270 160,210" stroke="#4DB6AC" stroke-width="1.5" opacity="0.10" />
        <path d="M90,300 Q130,270 160,210 Q120,260 90,300" fill="#4DB6AC" opacity="0.05" />
        <path d="M92,200 Q135,175 165,120" stroke="#4DB6AC" stroke-width="1.5" opacity="0.10" />
        <path d="M92,200 Q135,175 165,120 Q122,172 92,200" fill="#4DB6AC" opacity="0.05" />
      </svg>
    </div>
          ...
          <div class="htsd-slider" id="htsdTrack">
            ...
            @else
              <div class="htsd-pair htsd-pair--active">
                <div class="htsd-card">
                  <div class="htsd-q">&ldquo;&rdquo;</div>
                  <div class="htsd-stars"><span class="htsd-s filled">&#9733;</span><span
                      class="htsd-s filled">&#9733;</span><span class="htsd-s filled">&#9733;</span><span
                      class="htsd-s filled">&#9733;</span><span class="htsd-s filled">&#9733;</span></div>
                  <p class="htsd-msg">The prenatal yoga classes were a game-changer for my second pregnancy. I felt so much
                    stronger and more prepared compared to my first.</p>
                  <div class="htsd-author">
                    <div class="htsd-auth-img"><span>A</span></div>
                    <div>
                      <div class="htsd-auth-name">Ananya Reddy</div>
                      <div class="htsd-auth-role">Mother of Two</div>
                    </div>
                  </div>
                </div>
                <div class="htsd-card">
                  ...
                  <div class="htsd-stars"><span class="htsd-s filled">&#9733;</span><span
                      class="htsd-s filled">&#9733;</span><span class="htsd-s filled">&#9733;</span><span
                      class="htsd-s filled">&#9733;</span><span class="htsd-s filled">&#9733;</span></div>
                  <p class="htsd-msg">Anu's guidance during my pregnancy was priceless. Her breathing techniques and doula
                    support made my birth journey calm and empowered.</p>
                  <div class="htsd-author">
                    <div class="htsd-auth-img"><span>P</span></div>
                    <div>
                      <div class="htsd-auth-name">Priya Sharma</div>
                      <div class="htsd-auth-role">First-time Mother</div>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <div class="home-faq-grid">
        ...
        <div class="home-faq-left reveal">
          ...
          <div class="home-faq-touch">
            <a href="{{ route('contact') }}" class="home-faq-touch-btn">Get In Touch <span
                class="home-faq-touch-btn-icon">&rarr;</span></a>
        ...
        <div class="home-faq-right reveal d1">
          ...
          @else
            <div class="home-faq-item" data-faq>
              ...
              <div class="home-faq-answer">
                <p>A birth doula provides continuous physical, emotional, and informational support during pregnancy, labor,
                  and the postpartum period. Anu helps you feel calm, informed, and empowered throughout your birthing
                  journey.</p>
              </div>
            </div>
            <div class="home-faq-item" data-faq>
              ...
              <div class="home-faq-answer">
                <p>Ideally, connect with your doula during the second trimester so there's enough time for prenatal
                  sessions, birth planning, and building a trusting relationship before your due date.</p>
              </div>
            </div>
            <div class="home-faq-item" data-faq>
              <button class="home-faq-question" type="button">
              ...
              <div class="home-faq-answer">
                <p>Yes! Jiva Birth and Beyond offers prenatal yoga sessions and personalized nutrition consultations to
                  support your physical and mental well-being throughout pregnancy.</p>
              </div>
            </div>
            <div class="home-faq-item" data-faq>
              <button class="home-faq-question" type="button">
              ...
              <div class="home-faq-answer">
                <p>Absolutely. We offer a free initial consultation where you can discuss your needs, ask questions, and
                  understand how Anu can support your unique birth plan.</p>
              </div>
            </div>
          @endif
        </div>
