...
<style>
  ...
  @media (max-width: 560px) {
    ...
    .home-banners-section .banner-slide-button { padding: 14px 28px !important; font-size: 16px !important; margin-top: 16px !important; }
  }
    ...
    <div class="why-journey-grid why-journey-grid--four">
      ...
      <div class="why-journey-step reveal d1">
        <div class="why-img-wrap why-icon-wrap">
          <img src="{{ !empty($siteSettings['why_choose_image_1']) ? asset($siteSettings['why_choose_image_1']) : asset('images/why-choose/01_new.png') }}" alt="Personalized, One-on-One Support" class="why-icon">
      ...
      <div class="why-journey-step reveal d2">
        <div class="why-img-wrap why-icon-wrap">
          <img src="{{ !empty($siteSettings['why_choose_image_2']) ? asset($siteSettings['why_choose_image_2']) : asset('images/why-choose/02_new.png') }}" alt="Holistic Approach to Wellness & Birth" class="why-icon">
      ...
      <div class="why-journey-step reveal d3">
        <div class="why-img-wrap why-icon-wrap">
          <img src="{{ !empty($siteSettings['why_choose_image_3']) ? asset($siteSettings['why_choose_image_3']) : asset('images/why-choose/03_new.png') }}" alt="Guided by Experience & Understanding" class="why-icon">
      ...
      <div class="why-journey-step reveal d4">
        <div class="why-img-wrap why-icon-wrap">
          <img src="{{ !empty($siteSettings['why_choose_image_4']) ? asset($siteSettings['why_choose_image_4']) : asset('images/why-choose/04_new.png') }}" alt="Ongoing Support & Guidance" class="why-icon">
...
<section class="book-appointment-section" id="book-appointment">
        ...
        <form action="{{ route('contact.store') }}" method="POST" class="book-form" id="homeBookConsultationForm">
          ...
          <div class="bf-field">
            ...
            <button type="button" class="bf-cal-trigger" id="homeBfOpenCal">
              ...
              <svg class="bf-cal-chev" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><polyline points="6 9 12 15 18 9"/></svg>
            </button>
  ...
  <style>
    ...
    .bf-cal-trigger:hover { border-color: #4DB6AC; background: #ffffff; }
    .bf-cal-trigger.has-value { color: #2b2b2b; }
    .bf-cal-chev { margin-left: auto; flex-shrink: 0; color: #9ca3af; }
    .bf-time-confirm {
      display: flex;
      align-items: center;
      gap: 10px;
    ...
    .bf-change-btn:hover { background: #2FA9A3; color: #fff; }
    .bf-phone-group {
      display: flex;
      align-items: stretch;
      border: 1.5px solid #ead9d1;
